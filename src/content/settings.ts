...
export const globalSettings: GlobalSettings = {
  ...
  defaultDescription:
    "VictoryOne presents furnished residential and commercial projects, leadership insight, awards, media, events, careers, and direct contact information in one modern corporate experience.",
  ...
  offices: [
    {
      ...
      address: "VictoryOne, H-56, Sector 63, Noida 201301",
      mapEmbedUrl:
    ...
    },
    {
      ...
      label: "Site Office",
      address: "VictoryOne Amara, GH-05 C, Sector 16, Greater Noida West",
      mapEmbedUrl:
    ...
    },
    {
      ...
      label: "Site Office",
      address: "VictoryOne Central, Plot No. 02 E, Sector 12, Greater Noida West",
      mapEmbedUrl:
